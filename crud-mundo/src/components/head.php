...
<head>
    ...
    <link rel="stylesheet" href="<?= strpos($_SERVER['SCRIPT_NAME'], '/src/pages/') ? '../../' : '' ?>dist/output.css">
    ...
    <link
        ...
        rel="stylesheet">
    <script src="<?= strpos($_SERVER['SCRIPT_NAME'], '/src/pages/') ? '../' : 'src/' ?>assets/js/main.js" defer></script>
